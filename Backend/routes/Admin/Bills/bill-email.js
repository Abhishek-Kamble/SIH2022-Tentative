            ...
            "Html": {
              ...
              "Data":
                ...
                <head>
                  ...
                  <title>Your Property Tax Bill</title>
                  <meta name="description" content="Your bill">
                  <style type="text/css">
                                      ...
                                      <td style="height:20px;">&nbsp;</td>
                                              ...
                                              <tr>
                                                  <td style="padding:0 35px;">
                                                      <h1 style="color:#1e1e2d; font-weight:500; margin:0;font-size:32px;font-family:'Rubik',sans-serif;">Your property property!</h1>
                                                      <span
                                                          style="display:inline-block; vertical-align:middle; margin:29px 0 26px; border-bottom:1px solid #cecece; width:100px;"></span>
                                                      <p style="color:#455056; font-size:15px;line-height:24px; margin:0;">
                                                        Dear <strong>${req.name}</strong>, please find the annual property tax bill in the attachments below.
                                                      </p>             
                                                    <p> <strong>Property ID: </strong> ${req.property_id} </p>
                                                    <p style="color:#455056; font-size:15px;line-height:24px; margin:10;">                
                                                      <p> Kindly pay the bill before to avoid inconvineince in services</p>
